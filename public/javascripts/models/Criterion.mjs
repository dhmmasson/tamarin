...
class Criterion extends EventFirer {
   ...
   * @param  {string} [serialization.description]   - description of the criteria, name if absent
   ...
   *
   * @param  {Score} value the evaluation to blur
  ...
  /**
   * set weight - Change the weight of this criteria in the final mix
   *
  ...
  /**
   * get weight - get the weight associated to this criteria.
   *
  ...
  /**
   * set blurIntensity - the blur intensity represent how much the value of the technology should be smeared before computing the dominance
   * fire the event event:Criterion.eventType.blurIntensityUpdated followed by event event:Criterion.eventType.updated
   *
  ...
  /**
   * get blurIntensity - return the intensity of the blur
   *
